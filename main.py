...
def win_screen(player):
    current_player=text.render(f"{player} wins" ,1,(255,255,255))
...
def main():
    ...
    while True:
        ...
        if first_open.state=='Player2' and second_open.state=='Player2' and third_open.state=='Player2':
            win_screen('Player 2')
